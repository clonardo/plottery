...
const BRAND = `#0f4c81`; // A nice blue
...
export const brand = createPalette(BRAND);
...
export const dark: CorePaletteMap = {
  ...
  core: {
    ...
    lightBackground: brand.D3,
    // darkBackground: offblack.D4,
    darkBackground: brand.D4,
    alternateBackground: brand.D1,
    // alternateBackground: offblack.D1,
    offBackground: offblack.base,
    textColor: WHITE,
    backgroundHoverColor: brand.D4,
